...
import type { LocalizedPost } from "@/app/posts-localized";

const fetcher = (url: string) => fetch(url).then(res => res.json());

export function PostHeader({ posts, lang }: { posts: Post[] | LocalizedPost[], lang: string }) {
  const segments = useSelectedLayoutSegments();
  // The last segment will be the post ID
...
function Views({ id, mutate, defaultValue }: { id: string, mutate: any, defaultValue: string }) {
